...
// font
static char *fontstr = "JetBrains Mono NL:size=10";
// tag names
...
static pixman_color_t active_bg_color = HEX_COLOR(0xcc241dff);
...
static pixman_color_t middle_bg_color = HEX_COLOR(0x00000000);
